...
class _AutrePageState extends State<AutrePage> {
  ...
  Future<void> _loadBirthdays() async {
    ...
    setState(() {
      birthdays.clear();
      birthdays.addAll(
        data.where((birthday) => birthday['groupName'] == 'Autre'),
      );
    });
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    validator: (value) =>
                    value == null ? "Veuillez choisir un groupe" : null,
                  ),
                ],
              ),
            ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Anniversaires-Autre'),
      ),
      body: birthdays.isEmpty
          ? Center(
        child: Text(
          "Aucun anniversaire ajouté.",
        ...
        itemBuilder: (context, index) {
          ...
          return ListTile(
            ...
            subtitle: Text(
                '${birthday['date']} - Groupe : ${birthday['groupName']}'),
            trailing: Wrap(
              children: [
                IconButton(
                  icon: Icon(Icons.edit),
                  onPressed: () => {}, // Call update function here
                ),
                IconButton(
